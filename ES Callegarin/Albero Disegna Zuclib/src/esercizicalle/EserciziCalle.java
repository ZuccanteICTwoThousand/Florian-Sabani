 ...
 * @author Florian
 */
public class EserciziCalle extends JPanel{

    
    static JFrame schermo;
    private AlberoBinario albero;

    EserciziCalle(AlberoBinario albero) {
    ...
    private static void apriFinestra(AlberoBinario b) {
        ...
        schermo = new JFrame();
        schermo.add(new EserciziCalle(b));
