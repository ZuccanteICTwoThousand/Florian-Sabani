...
/**
 * La classe incapsula una lista e fornisce i metodi necessari all'accesso e alla gestione dei suoi elementi. La classe Ã¨ generica, perciÃ² permette sia la gestione di una coda FiFO e LIFO, la cui implementazione Ã¨ lasciata alle sottoclassi.
 */
public class List {
    /**
     * Il primo elemento della lista. null se la lista Ã¨ vuota.
     */
    protected ListItem head;

    /**
     * L'ultimo elemento della lista, null se Ã¨ vuota.
     */
     ...
     * @return Il numero di elementi rimossi; 0 se la lista Ã¨ vuota.
     */
    ...
    /**
     * Ritorna se la lista Ã¨ vuota o no.
     * @return true se la lista Ã¨ vuota. false altrimenti.
     */
