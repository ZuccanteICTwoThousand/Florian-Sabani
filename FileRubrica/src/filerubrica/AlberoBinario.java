...
public class AlberoBinario {
    ...
    private Contatto[] lista;

    public AlberoBinario(Contatto[] lista) {
        this.lista = lista;
     ...
     * @param mioOggetto
     */
    public void aggiungiNodo(Contatto mioOggetto) {
    ...
    public void aggiungiNodi(Contatto[] alunni) {
    ...
    public void eliminaNodo(Contatto daCercare) {
    ...
    public Nodo trovaNodo(Contatto daCercare) {
    ...
    private void concatenaLista(Contatto[] alunni) {

        int nuovaGrandezza = lista.length + alunni.length;

        Contatto[] nuovaLista = new Contatto[nuovaGrandezza];
